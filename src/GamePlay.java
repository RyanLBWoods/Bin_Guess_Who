...
public class GamePlay {
    ...
    public static double[] playGame(){
        ...
        System.out.println(early_no[0] + "," + early_no[1] + "," +early_no[2] + "," +early_no[3] + "," +early_no[4]);
        System.out.println(early_yes[0] + "," + early_yes[1] + "," +early_yes[2] + "," +early_yes[3] + "," +early_yes[4]);
